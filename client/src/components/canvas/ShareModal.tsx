        ...
        <div className="modal-body">
          ...
          <div className="share-user-row">
            <div
              ...
              style={{
                background: UserColorService.getColor(userId),
                width: 32,
                height: 32,
                fontSize: 12,
              }}
            ...
            <div className="share-user-info">
              <div className="share-user-name">
                {userName} <span className="share-you-badge">(you)</span>
              </div>
          ...
          {activeUsers.map((u) => (
            <div key={u.id} className="share-user-row">
              ...
              {onPermissionChange ? (
                ...
                <span
                  className={`share-role-badge share-role-badge--${u.permission === 'viewer' ? 'viewer' : 'editor'}`}
                >
